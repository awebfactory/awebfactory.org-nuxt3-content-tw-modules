    ...
    <div class="mx-auto max-w-7xl overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-4 flex justify-center space-x-6">
        ...
        <NuxtLink
          ...
          :key="item.name"
          :to="item.href"
          class="mt-4 text-gray-400 hover:text-gray-500"
        >
        ...
        <div class="px-5 pt-0 pb-2">
          <NuxtLink
            to="https://awebfactory.com"
            class="text-base text-gray-500 hover:text-gray-900"
          >
            <img
              src="/logo.png"
              class="hidden sm:block mt-2 w-30 h-8"
              alt="AWebFactory.com site"
              title="AWebFactory.com site"
            />
          </NuxtLink>
        </div>
      </div>
...
const navigation = {
  ...
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/AWebFactory",
    ...
    */
    ...
    {
      name: "Twitter",
      href: "https://twitter.com/a_web_factory",
      icon: defineComponent({
        render: () =>
          h("svg", { fill: "currentColor", viewBox: "0 0 24 24" }, [
            h("path", {
    ...
    {
      name: "GitHub",
      href: "https://github.com/awebfactory",
      icon: defineComponent({
        render: () =>
          h("svg", { fill: "currentColor", viewBox: "0 0 24 24" }, [
            h("path", {
    ...
    */
    ...
    /* Notice larger viewBox required for this and following icons */
    {
      name: "YouTube",
      href: "https://www.youtube.com/channel/UCiDKCDXshPLcg-Ku572rvqA",
      icon: defineComponent({
        render: () =>
    ...
    {
      name: "Twitch",
      href: "https://www.twitch.tv/awebfactory",
      icon: defineComponent({
        render: () =>
          h("svg", { fill: "currentColor", viewBox: "0 0 512 512" }, [
            h("path", {
